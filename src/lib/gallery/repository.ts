...
const gallerySelect = "id,created_at,title,image_url,content,is_published,sort_order";
...
export async function createGalleryPost(input: NormalizedGalleryPostForm) {
